...
REM Parameter 2: Windows user account for the pem file permissionsto be restricted to
REM Example usage:

@echo off
REM example usage C:\Users\Aleem\Documents\GitHub\splunk-on-aws\restrict_pem_key.bat "D:\AWS_Keys\SplunkStudyClub.pem" "aleem"
